function varargout = ConfirmCompartmentsMap_4Q(varargin)
%CONFIRMCOMPARTMENTSMAP_4Q MATLAB code file for ConfirmCompartmentsMap_4Q.fig
%      CONFIRMCOMPARTMENTSMAP_4Q, by itself, creates a new CONFIRMCOMPARTMENTSMAP_4Q or raises the existing
%      singleton*.
%
%      H = CONFIRMCOMPARTMENTSMAP_4Q returns the handle to a new CONFIRMCOMPARTMENTSMAP_4Q or the handle to
%      the existing singleton*.
%
%      CONFIRMCOMPARTMENTSMAP_4Q('Property','Value',...) creates a new CONFIRMCOMPARTMENTSMAP_4Q using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to ConfirmCompartmentsMap_4Q_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CONFIRMCOMPARTMENTSMAP_4Q('CALLBACK') and CONFIRMCOMPARTMENTSMAP_4Q('CALLBACK',hObject,...) call the
%      local function named CALLBACK in CONFIRMCOMPARTMENTSMAP_4Q.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help ConfirmCompartmentsMap_4Q

% Last Modified by GUIDE v2.5 10-Jun-2019 10:20:51

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ConfirmCompartmentsMap_4Q_OpeningFcn, ...
                   'gui_OutputFcn',  @ConfirmCompartmentsMap_4Q_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before ConfirmCompartmentsMap_4Q is made visible.
function ConfirmCompartmentsMap_4Q_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for ConfirmCompartmentsMap_4Q
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ConfirmCompartmentsMap_4Q wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ConfirmCompartmentsMap_4Q_OutputFcn(hObject, eventdata, handles)
...
for i = 1:NumElec
    color(MEA(i),:) = handles.(strcat('Toggle0',num2str(MEA(i)))).BackgroundColor;
end
